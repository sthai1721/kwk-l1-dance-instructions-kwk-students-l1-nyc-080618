...
def skip_step(position)
  puts "Lower #{position} foot to the ground"
  puts "Bounce #{position} foot back up slightly,kicking it a few inches back"
  puts "Briefly raise the opposite foot, then the #{position} twice more"
end
